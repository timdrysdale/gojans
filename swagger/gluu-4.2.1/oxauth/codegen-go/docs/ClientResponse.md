...
------------ | ------------- | ------------- | -------------
**RedirectUris** | **[]string** | Redirection URI values used by the Client. One of these registered Redirection URI values must exactly match the redirect_uri parameter value used in each Authorization Request | [optional] [default to null]
