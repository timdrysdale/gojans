...
type RegisterParams1 struct {
	...
	Jwks []JsonWebKey `json:"jwks,omitempty"`
	...
	SpontaneousScopes []string `json:"spontaneous_scopes,omitempty"`
	...
	AuthorizedOrigins []string `json:"authorized_origins,omitempty"`
	...
	AdditionalAudience []string `json:"additional_audience,omitempty"`
}
