...
func (m *RptIntrospectionResponse1) validateActive(formats strfmt.Registry) error {
...
func (m *RptIntrospectionResponse1) validatePermissions(formats strfmt.Registry) error {
...
func (m *RptIntrospectionResponse1) validateResourceID(formats strfmt.Registry) error {
...
func (m *RptIntrospectionResponse1) validateResourceScopes(formats strfmt.Registry) error {
...
func (m *RptIntrospectionResponse1) UnmarshalBinary(b []byte) error {
	var res RptIntrospectionResponse1
