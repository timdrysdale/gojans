...
func (m *UMA2ConfigurationResponse) validateAuthorizationEndpoint(formats strfmt.Registry) error {
...
func (m *UMA2ConfigurationResponse) validateIssuer(formats strfmt.Registry) error {
...
func (m *UMA2ConfigurationResponse) UnmarshalBinary(b []byte) error {
	var res UMA2ConfigurationResponse
