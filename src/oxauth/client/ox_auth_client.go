...
import (
	...
	"github.com/timdrysdale/gojans/go-swagger/gluu-4.2.1/oxauth/client/authorization"
	"github.com/timdrysdale/gojans/go-swagger/gluu-4.2.1/oxauth/client/client_info"
	"github.com/timdrysdale/gojans/go-swagger/gluu-4.2.1/oxauth/client/client_registration"
	"github.com/timdrysdale/gojans/go-swagger/gluu-4.2.1/oxauth/client/fido2"
	"github.com/timdrysdale/gojans/go-swagger/gluu-4.2.1/oxauth/client/fido_u2f"
	"github.com/timdrysdale/gojans/go-swagger/gluu-4.2.1/oxauth/client/jwk_json_web_key_set_j_w_ks"
	"github.com/timdrysdale/gojans/go-swagger/gluu-4.2.1/oxauth/client/registration"
	"github.com/timdrysdale/gojans/go-swagger/gluu-4.2.1/oxauth/client/server_configuration"
	"github.com/timdrysdale/gojans/go-swagger/gluu-4.2.1/oxauth/client/session_management"
	"github.com/timdrysdale/gojans/go-swagger/gluu-4.2.1/oxauth/client/token"
	"github.com/timdrysdale/gojans/go-swagger/gluu-4.2.1/oxauth/client/token_introspection"
	"github.com/timdrysdale/gojans/go-swagger/gluu-4.2.1/oxauth/client/uma_2_resource"
	"github.com/timdrysdale/gojans/go-swagger/gluu-4.2.1/oxauth/client/uma_scope"
	"github.com/timdrysdale/gojans/go-swagger/gluu-4.2.1/oxauth/client/uma_user_managed_access"
	"github.com/timdrysdale/gojans/go-swagger/gluu-4.2.1/oxauth/client/user_info"
)

// Default ox auth HTTP client.
...
// NewHTTPClient creates a new ox auth HTTP client.
func NewHTTPClient(formats strfmt.Registry) *OxAuth {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new ox auth HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *OxAuth {
...
// New creates a new ox auth client
func New(transport runtime.ClientTransport, formats strfmt.Registry) *OxAuth {
	// ensure nullable parameters have default
	if formats == nil {
...
// OxAuth is a client for ox auth
type OxAuth struct {
...
func (c *OxAuth) SetTransport(transport runtime.ClientTransport) {
