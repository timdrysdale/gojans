...
// NewGetUMAScopesParams creates a new GetUMAScopesParams object
// with the default values initialized.
func NewGetUMAScopesParams() *GetUMAScopesParams {

	return &GetUMAScopesParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetUMAScopesParamsWithTimeout creates a new GetUMAScopesParams object
...
// NewGetUMAScopesParamsWithContext creates a new GetUMAScopesParams object
...
// NewGetUMAScopesParamsWithHTTPClient creates a new GetUMAScopesParams object
...
/*GetUMAScopesParams contains all the parameters to send to the API endpoint
for the get uma scopes operation typically these are written to a http.Request
*/
type GetUMAScopesParams struct {
