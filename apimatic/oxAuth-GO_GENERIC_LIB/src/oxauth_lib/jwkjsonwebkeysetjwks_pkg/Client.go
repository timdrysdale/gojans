 ...
 */
type JWKJSONWEBKEYSETJWKS_IMPL struct {
     config configuration_pkg.CONFIGURATION
}

/**
 * Provides list of JWK used by server.
 * @return	Returns the *models_pkg.WebKeysConfiguration response from the API call
 */
func (me *JWKJSONWEBKEYSETJWKS_IMPL) GetJwks () (*models_pkg.WebKeysConfiguration, error) {
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    var retVal *models_pkg.WebKeysConfiguration = &models_pkg.WebKeysConfiguration{}
